...
const Nav = () => {
  ...
  return (
    <>
      <nav className="flex justify-between items-center w-full py-[10px] h-[4rem]  md:h-[5rem]  pl-[10px] overflow-hidden pr-[12px] md:px-[30px] bg-[#d7d9c7cb] font-bold font-sans ">
